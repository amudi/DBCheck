...
public class ParticipationConstraint implements IConstraint {
    ...
    /** Creates a new instance of ParticipationConstraint */
    public ParticipationConstraint(String p_Metadata) {
    ...
    public String getType() {
        return "Participation Constraint";
    }
